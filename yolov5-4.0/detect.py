...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp16/weights/best.pt', help='model.pt path(s)') # 模型权重文件
    parser.add_argument('--source', type=str, default="C:/Users/TLDX/Desktop/origin_image", help='source')  # file/folder, 0 for webcam # 数据源路径，0 则是使用摄像头
